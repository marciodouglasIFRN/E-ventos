...
from .views import Lista_Evento, Cria_Evento, Listar_Eventos_Por_Promotor, Detalhar_Evento, Atualizar_Evento,Listar_Eventos_Por_Categoria
...
urlpatterns = [
    ...
    path('listEventoPromotor-categoria/<str:categoria>/', Listar_Eventos_Por_Categoria.as_view(), name="list_evento_por_categoria"),
